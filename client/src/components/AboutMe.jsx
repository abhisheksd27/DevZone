...
<h3 className='text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-teal-400 via-blue-500 to-indigo-500 transition-transform transform hover:scale-105 animate-pulse'>
  Hi, I'm Abhishek Shankar
      ...
      As a final year student at CMR Institute of Technology 🎓, specializing in Information Science and Engineering, I excel in a variety of technologies. 
    ...
    <div className="p-7 flex-1">
      <img src={myPhoto} alt="JavaScript" className='w-full h-auto sm:max-w-xs rounded-lg shadow-md'/>
    </div>
  </div>
  );
};
